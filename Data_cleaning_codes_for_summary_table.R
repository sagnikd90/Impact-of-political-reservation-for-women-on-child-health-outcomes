...
main_data$first_election[main_data$state_name=="assam"]<- 2000

main_data$first_election_month[main_data$state_name=="assam"]<- 11


### Bihar ###

main_data$first_election[main_data$state_name=="bihar"]<- 2001

main_data$first_election_month[main_data$state_name=="bihar"]<- 4


### Goa ###

main_data$first_election[main_data$state_name=="goa"]<- 1997

main_data$first_election_month[main_data$state_name=="goa"]<- 1


### Haryana ###

main_data$first_election[main_data$state_name=="haryana"]<- 1994

main_data$first_election_month[main_data$state_name=="haryana"]<- 6

### Maharashtra ###

main_data$first_election[main_data$state_name=="maharashtra"]<- 1992

main_data$first_election_month[main_data$state_name=="maharashtra"]<- 11

### Manipur ###

main_data$first_election[main_data$state_name=="manipur"]<- 1997

main_data$first_election_month[main_data$state_name=="manipur"]<- 1

### Punjab ###

main_data$first_election[main_data$state_name=="punjab"]<- 1998

main_data$first_election_month[main_data$state_name=="punjab"]<- 6

### Orissa ###

main_data$first_election[main_data$state_name=="orissa"]<- 1992

main_data$first_election_month[main_data$state_name=="orissa"]<- 5

### Tamil Nadu ###

main_data$first_election[main_data$state_name=="tamil nadu"]<- 1996

main_data$first_election_month[main_data$state_name=="tamil nadu"]<- 10
...
write.csv(df_panel,"Preferred_sample_data_for_summary_tables.csv")