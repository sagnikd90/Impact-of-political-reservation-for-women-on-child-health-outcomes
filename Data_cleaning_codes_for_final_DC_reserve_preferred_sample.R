...
setwd("C:\\Users\\das90\\OneDrive - Cuny GradCenter\\Research\\Political reservation and age of marriage\\Github\\Political-reservation-and-age-of-marriage-age-of-first-birth\\Final version\\Cleaned datasets")

df_1<- read.csv("C:\\Users\\das90\\OneDrive - Cuny GradCenter\\Research\\Political reservation and age of marriage\\Github\\Political-reservation-and-age-of-marriage-age-of-first-birth\\Cleaned_DLHS_2.csv")
...
######################## District chairperson reservations ####################################

main_data$dist_resv<- 0

main_data$dist_resv[main_data$state_name=="andhra pradesh" & 
                      main_data$district_name=="adilabad"|
                      main_data$district_name=="east godavari"|
                      main_data$district_name=="nellore"|
                      main_data$district_name=="nizamabad"|
                      main_data$district_name=="srikakulam"|
                      main_data$district_name=="visakhapatnam"|
                      main_data$district_name=="west godavari"]<- 1

main_data$dist_resv[main_data$state_name=="gujarat" & 
                      main_data$district_name=="ahmadabad"|
                      main_data$district_name=="banas kantha"|
                      main_data$district_name=="bhavnagar"|
                      main_data$district_name=="gandhinagar"|
                      main_data$district_name=="jamnagar"]<- 1

main_data$dist_resv[main_data$state_name=="haryana" & 
                      main_data$district_name=="hisar"|
                      main_data$district_name=="mahendragarh"|
                      main_data$district_name=="panipat"|
                      main_data$district_name=="rewari"|
                      main_data$district_name=="sirsa"|
                      main_data$district_name=="yamunanagar"]<- 1

main_data$dist_resv[main_data$state_name=="kerala" & 
                      main_data$district_name=="alappuzha"|
                      main_data$district_name=="kannur"|
                      main_data$district_name=="malappuram"|
                      main_data$district_name=="pathanamthitta"|
                      main_data$district_name=="thrissur"]<- 1

main_data$dist_resv[main_data$state_name=="maharashtra" & 
                      main_data$district_name=="bid"|
                      main_data$district_name=="bhandara"|
                      main_data$district_name=="chandrapur"|
                      main_data$district_name=="dhule"|
                      main_data$district_name=="nanded"|
                      main_data$district_name=="nashik"|
                      main_data$district_name=="osmanabad"|
                      main_data$district_name=="satara"|
                      main_data$district_name=="sindhudurg"|
                      main_data$district_name=="solapur"]<- 1

main_data$dist_resv[main_data$state_name=="orissa" & 
                      main_data$district_name=="anugul"|
                      main_data$district_name=="cuttack"|
                      main_data$district_name=="debgarh"|
                      main_data$district_name=="ganjam"|
                      main_data$district_name=="jajpur"|
                      main_data$district_name=="kandhamal"|
                      main_data$district_name=="kendrapara"|
                      main_data$district_name=="mayurbhanj"|
                      main_data$district_name=="puri"|
                      main_data$district_name=="sundargarh"]<- 1

main_data$dist_resv[main_data$state_name=="rajasthan" & 
                      main_data$district_name=="banswara"|
                      main_data$district_name=="bharatpur"|
                      main_data$district_name=="bundi"|
                      main_data$district_name=="churu"|
                      main_data$district_name=="jaipur"|
                      main_data$district_name=="jaisalmer"|
                      main_data$district_name=="nagaur"|
                      main_data$district_name=="pali"|
                      main_data$district_name=="sawai madhopur"|
                      main_data$district_name=="tonk"|
                      main_data$district_name=="udaipur"]<- 1

main_data$dist_resv[main_data$state_name=="west bengal" & 
                      main_data$district_name=="birbhum"|
                      main_data$district_name=="barddhaman"|
                      main_data$district_name=="dakshin dinajpur"|
                      main_data$district_name=="north twentyfour parganas"|
                      main_data$district_name=="medinipur"]<- 1
...
df_panel<- df_panel%>%
  ...
  mutate(state_id=as.numeric(as.factor(state_name))) ################ Final data for analysis ###################

write.csv(df_panel,"Preferred_sample_data_for_dist_level_analysis.csv")